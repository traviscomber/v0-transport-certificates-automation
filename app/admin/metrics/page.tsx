...
import { FileCheck, TrendingUp, Users, Building2, RefreshCw, Lock, Eye, EyeOff } from 'lucide-react'
...
export default function MetricsPage() {
  ...
  useEffect(() => {
    ...
    const authorized = sessionStorage.getItem('admin-metrics-authorized') === 'true'
  ...
  const handleKeySubmit = (e: React.FormEvent) => {
    ...
    if (keyInput === AUTHORIZED_KEY) {
      ...
      sessionStorage.setItem('admin-metrics-authorized', 'true')
      setKeyInput('')
      setShowKey(false)
    } else {
        ...
        <Card className="w-full max-w-md shadow-2xl border-primary/20">
          <CardHeader className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-t-lg border-b-2 border-primary">
            ...
            <CardDescription className="text-white/80">
              Ingresa la clave para ver las métricas ejecutivas
            </CardDescription>
          </CardHeader>
