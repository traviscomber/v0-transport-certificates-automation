import { Users, LogOut, LayoutDashboard, FileText, Clock } from "lucide-react"
import Link from "next/link"
import { createClient } from "@/lib/supabase/server"
import { redirect } from "next/navigation"

const navItems = [
  { href: "/conductor", label: "Mi Perfil", icon: LayoutDashboard },
  { href: "/conductor/documentos", label: "Mis Documentos", icon: FileText },
  { href: "/conductor/calendario", label: "Vencimientos", icon: Clock },
]
    ...
    <div className="flex h-screen bg-[#FAFAFA]">
      ...
      <main className="flex-1 overflow-auto">
        <header className="border-b border-[#E4E4E7] bg-white px-8 py-4 flex justify-between items-center">
          <h1 className="text-lg font-semibold text-[#18181B]">Mi Perfil Conductor</h1>
