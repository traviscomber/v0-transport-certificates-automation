    ...
    <div className="min-h-screen bg-slate-900 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card className="border-slate-600/40 bg-slate-500/10">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-slate-300">Alertas</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-slate-200">Monitor</div>
              <p className="text-xs text-slate-600 mt-1">Documentos por vencer</p>
            </CardContent>
          </Card>
        </div>
