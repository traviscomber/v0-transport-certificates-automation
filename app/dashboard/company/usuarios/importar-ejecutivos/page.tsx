...
export const metadata = {
  title: 'Importar Ejecutivos - Labbe',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <Link href="/dashboard/company/usuarios" className="inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-700 mb-2">
      ...
      <div className="grid gap-6 max-w-2xl">
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg space-y-2">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1 list-disc list-inside">
            ...
            <li>Se crearán como usuarios con rol &quot;admin&quot;</li>
