...
# Read the conductores data file
data_file = Path('/vercel/share/v0-project/scripts/conductores-data.txt')

if not data_file.exists():
    print("[v0] Data file not found, reading from attachment...")
    # Create the data file from the attachment
    with open('/vercel/share/v0-project/scripts/conductores-data.txt', 'w') as f:
        f.write("""Rut_Conductor	Conductor	Rut_Proveedor	Proveedor	Patente Tracto
...
print("[v0] Data file created")

# Read and parse the data
with open('/vercel/share/v0-project/scripts/conductores-data.txt', 'r') as f:
    lines = f.readlines()
...
print(f"[v0] Parsed {len(drivers)} drivers from file")

# Save to JSON for reference
with open('/vercel/share/v0-project/scripts/drivers-list.json', 'w') as f:
    import json
    json.dump(drivers, f, indent=2)

print("[v0] Drivers data saved to drivers-list.json")
print("[v0] Ready to sync to Supabase")
