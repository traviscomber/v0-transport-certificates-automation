...
async function insertDocumentTypes() {
  ...
  const documentTypes = [
    ...
    { code: 'F30-1_DOÑA_ISIDORA', nombre: 'F30-1 Doña Isidora', descripcion: 'F30-1 Emitido a Doña Isidora', periodicidad: 'Anual', es_obligatorio: true },
    { code: 'F30-1_CLIENTE', nombre: 'F30-1 Emitido a Cliente', descripcion: 'F30-1 Emitido a cliente', periodicidad: 'Anual', es_obligatorio: true },
