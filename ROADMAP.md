...
Last updated: 2026-08-08 13:28 CLT
...
- May 2026 RB is actively draining under the corrected oldest-first policy and has advanced to cursor 70,000.
...
1. **Drain final Stage 9 PRT import**
   - May 2026 RB -> EOF / imported. Current verified cursor: 70,000.
   - Current verified May RB accounting: 70,000 rows read / 69,807 valid / 193 rejected/duplicate-accounted.
...
- `prt_import_stream`: latest observed production run `completed`, `failed_count = 0`, May 2026 RB cursor 70,000.
...
- May 2026 RB: `profiled`, cursor 70,000 / 69,807 valid / 193 rejected/duplicate-accounted — final Stage 9 PRT batch actively draining.
