        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="email" name="email" type="email" placeholder="usuario@empresa.cl" className="pl-10" required />
            </div>
          </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="name" name="name" type="text" placeholder="Juan Pérez" className="pl-10" required />
            </div>
          </div>
