...
export function AdminDocumentUpload({ onUploadSuccess }: AdminDocumentUploadProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Cargar Documentos (Admin)</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setSelectedCategory(documentType === 'driver' ? 'License' : 'Contract')
              }}
          ...
          {/* ID Input */}
          <div>
            <label className="text-sm font-medium">ID/UUID</label>
            <input
              type="text"
              value={selectedId}
        ...
        >
          ...
          <label htmlFor="file-input" className="block mt-4">
            <Button disabled={uploading || !selectedId} variant="outline" type="button">
              {uploading ? (
                <>
