...
const MATRIX_COLUMNS: MatrixColumn[] = [
  ...
  { key: 'f30_1_lts', group: 'Mensual', label: 'F30-1 Lts', codes: ['F30-1_CLIENTE', 'F30-1_DO脩A_ISIDORA', 'F30-1_DO脩A_ISIDORA', 'F30-1 LTS', 'F30-1_LTS'], hints: ['f30-1 lts', 'lts'] },
  ...
  { key: 'cedula_representante', group: 'Empresa', label: 'C茅dula representante', codes: ['CEDULA-REPRESENTANTE', 'CEDULA_IDENTIDAD'], hints: ['cedula representante', 'c茅dula representante'] },
  ...
  { key: 'revision_tecnica', group: 'Vehiculo', label: 'Revisi贸n t茅cnica', codes: ['REVISION-TECNICA', 'REVISION_TECNICA'], hints: ['revision tecnica'] },
  { key: 'soap', group: 'Vehiculo', label: 'SOAP', codes: ['SOAP', 'SEGURO-SOAP'], hints: ['soap'] },
  { key: 'permiso_circulacion', group: 'Vehiculo', label: 'Permiso circulaci贸n', codes: ['PERMISO-CIRCULACION', 'PERMISO_CIRCULACION'], hints: ['permiso circulacion'] },
  { key: 'padron_vehiculo', group: 'Vehiculo', label: 'Padr贸n veh铆culo', codes: ['PADRON-VEHICULO', 'PADRON'], hints: ['padron', 'padr贸n'] },
  ...
  { key: 'contrato_subcontratacion', group: 'Subcontratacion', label: 'Contrato subcontrataci贸n', codes: ['CONTRATO-SUBCONTRATACION'], hints: ['contrato subcontratacion'] },
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-xl border border-slate-700/50 bg-slate-950/50 px-4 py-3 text-sm text-slate-300">
          ...
          <div className="flex flex-nowrap items-center gap-2 overflow-x-auto pb-1">
            <span className="sticky left-0 z-10 mr-1 shrink-0 bg-slate-950/50 pr-2 font-semibold uppercase tracking-[0.18em] text-slate-400">Filtro alfab閠ico</span>
            <button
              type="button"
